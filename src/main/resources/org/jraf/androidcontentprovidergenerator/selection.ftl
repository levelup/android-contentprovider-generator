...
public class ${entity.nameCamelCase}Selection extends AbstractSelection<${entity.nameCamelCase}Selection> {
    ...
    @Override
    protected Uri baseUri(String authority) {
        return Uri.parse(RSSProvider.getContentUriBase(authority) + "/" + ${entity.nameCamelCase}Columns.TABLE_NAME);
    }
    
    /**
     * Query the given content resolver using this selection for the given authority.
     *
     ...
     */
    public ${entity.nameCamelCase}Cursor query(String authority, ContentResolver contentResolver, String[] projection, String sortOrder) {
        Cursor cursor = contentResolver.query(uri(authority), projection, sel(), args(), sortOrder);
     ...
     * Equivalent of calling {@code query(contentResolver, projection, null)}.
     */
    public ${entity.nameCamelCase}Cursor query(String authority, ContentResolver contentResolver, String[] projection) {
        return query(authority, contentResolver, projection, null);
    }
